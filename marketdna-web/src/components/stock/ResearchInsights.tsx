...
const CATEGORY_CONFIG = {
  trend:     { color: '#3b82f6', Icon: TrendingUpIcon },
  momentum:  { color: '#22c55e', Icon: SpeedIcon },
  risk:      { color: '#f59e0b', Icon: WarningAmberIcon },
  strength:  { color: '#a78bfa', Icon: EmojiEventsIcon },
}
        ...
        <Stack spacing={1.5}>
          {[...high, ...medium].map((insight, i) => {
            ...
            return (
              ...
              >
                <Box sx={{ width: 32, height: 32, borderRadius: '50%', bgcolor: `${color}15`, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                ...
                <Box flex={1}>
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 0.25 }}>
                    ...
                    <Box sx={{ width: 6, height: 6, borderRadius: '50%', bgcolor: SIG_COLOR[insight.significance], flexShrink: 0 }} />
                  </Box>
